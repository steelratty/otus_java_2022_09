...
public class WebServerWithClients {
    ...
    private static final Logger log = LoggerFactory.getLogger(WebServerWithClients.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        UsersWebServer usersWebServer = new ClientsUsersWebServer(WEB_SERVER_PORT,
